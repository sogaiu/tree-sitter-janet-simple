...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (('4' <= lookahead && lookahead <= '9')) ADVANCE(41);
    ...
    case 44:
      ACCEPT_TOKEN(sym__dec);
      if (lookahead == '.') ADVANCE(53);
      if (('0' <= lookahead && lookahead <= '6')) ADVANCE(41);
      if (lookahead == ':') ADVANCE(9);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(5);
      if (lookahead == 'r') ADVANCE(4);
    ...
    case 50:
      ACCEPT_TOKEN(sym__dec);
      if (lookahead == '.') ADVANCE(56);
      if (('0' <= lookahead && lookahead <= '6')) ADVANCE(47);
      if (lookahead == ':') ADVANCE(82);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(75);
      if (lookahead == 'r') ADVANCE(65);
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [41] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(23),
  [44] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(34),
  [47] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(2),
  [50] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(28),
  [53] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(2),
  ...
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(8),
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(9),
  [71] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(3),
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(16),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(17),
  [80] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(18),
  [83] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(19),
  ...
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source, 1),
  ...
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sqr_arr_lit, 2),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sqr_arr_lit, 2),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_lit, 2),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_struct_lit, 2),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bool_lit, 1),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bool_lit, 1),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tbl_lit, 2),
  [177] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tbl_lit, 2),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_par_arr_lit, 2),
  [181] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_par_arr_lit, 2),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_par_tup_lit, 2),
  [185] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_par_tup_lit, 2),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sqr_tup_lit, 2),
  [189] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sqr_tup_lit, 2),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_num_lit, 1),
  [193] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_num_lit, 1),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_qq_lit, 2),
  [197] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_qq_lit, 2),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quote_lit, 2),
  [201] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quote_lit, 2),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_short_fn_lit, 2),
  [205] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_short_fn_lit, 2),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splice_lit, 2),
  [209] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splice_lit, 2),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unquote_lit, 2),
  [213] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unquote_lit, 2),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_kwd_lit, 1),
  [217] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_kwd_lit, 1),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_par_arr_lit, 3),
  [221] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_par_arr_lit, 3),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sqr_arr_lit, 3),
  [225] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sqr_arr_lit, 3),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_lit, 3),
  [229] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_struct_lit, 3),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tbl_lit, 3),
  [233] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tbl_lit, 3),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_par_tup_lit, 3),
  [237] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_par_tup_lit, 3),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sqr_tup_lit, 3),
  [241] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sqr_tup_lit, 3),
